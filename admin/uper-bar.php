...
<head>
    ...
    <!-- End layout styles -->
    <link rel="shortcut icon" href="image/Escool.png" />
</head>
    ...
    <div class="container-scroller">
        ...
        <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
                ...
                <a class="navbar-brand brand-logo" href="dashboard.php"><img style="height: 60px;" src="../index/img/310182337_783307596233828_2070287894972276206_n.png" alt="logo" /></a>
