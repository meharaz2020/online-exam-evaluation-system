...
if (isset($_POST['submit'])) {
    ...
    if (!$uname == "") {
        ...
        $querys = mysqli_query($db, "SELECT * FROM users WHERE username ='$uname' OR roll ='$uname'");
        if (mysqli_num_rows($querys) == 1) {
            ...
            $usernames_errors = "This Username  not found";
        }
    } else {
                    ...
                    <div class="card-body">
                        ...
                        <form class="forms-sample" action="" method="POST" enctype="multipart/form-data">
                            <div class="form-group">
                                <label for="exampleInputUsername1">Username or mail</label>
